...
function Zb(a,b){
    function e(){
        ...
        function f(u){ 
        var fa=m("<td class='fc-header-"+u+"'/>"+strop(u)+"");
                    ...
                    if(ha){
                        ...
                        if(na){
                            na.click(function(){
                                ...
                                na.not("."+q+"-state-active").not("."+q+"-state-disabled").addClass(q+"-state-down1")
                                }).mouseup(function(){
                                na.removeClass(q+"-state-down1")
                                }).hover(function(){
                                na.not("."+q+"-state-active").not("."+q+"-state-disabled").addClass(q+"-state-hover1")
                                },function(){
                                na.removeClass(q+"-state-hover1").removeClass(q+"-state-down1")
                                }).appendTo(fa);
