...
if ( !@file_exists( '/var/www/floor.com/www/js/ckeditor/ckeditor.php' ) )
{
	if ( @file_exists('/var/www/floor.com/www/js/ckeditor/ckeditor.js') || @file_exists('/var/www/floor.com/www/js/ckeditor/ckeditor_source.js') )
		printNotFound('CKEditor 3.1+');
	else
		printNotFound('CKEditor');
}

include_once '/var/www/floor.com/www/js/ckeditor/ckeditor.php' ;
require_once '/var/www/floor.com/www/js/ckeditor/ckfinder/ckfinder.php' ;
...
else
{
	...
	$ckeditor->basePath	= '/var/www/floor.com/www/js/ckeditor/' ;
