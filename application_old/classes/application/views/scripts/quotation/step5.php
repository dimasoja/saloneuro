    ...
    <form method="post" id="quotation_form" action="<?php echo URL::base(); ?>online-quotation" enctype="multipart/form-data">
        ...
        <div id="online-maintainence-main">
            <div id="online-maintainence-form">
                ...
                <h3 style="padding:0;"><span style="color: #FF6418; font-size: 24px;">Your reference number for this order is: </span><font size="6"><?php print($_SESSION['id']); ?></font><h3>
                <h3 style="padding:0;"><span style="color: #FF6418; font-size: 24px;">Your reference transaction id for this order is: </span><font size="6"><?php echo $transaction_id; ?></font><h3>        <h3 style="padding-bottom:40px;"><span style="color: #FF6418; font-size: 24px;">Date: </span><span><?php echo date('j F Y', time()); ?></span><h3>
                                        ...
                                        if ($staining_area != "" && $staining_area != "none") {
                                            ...
                                            <tr class="s_tr">
                                                ...
                                                <td align="center">
                                                    ...
                                                    ?>
                                                    <span class="table_content"><?php $subtotal_extras+=$subtotal;
                                                print(number_format($subtotal, 2)); ?></span>
                                                </td>
										...
										<?php if($option == "2") {  ?>
                                            ...
                                            <tr>
                                                    ...
                                                    <td align=center style="font-size: 24px; font-weight: bold; background-color: #373131;" >								
                                                        <font size="5" style="color: white">£<?php print( number_format($total_price_for_job * (10 / 9) * 0.1, 2)); ?></font>
                                                    </td>
                                                </tr>
                                                <?php if ($sale != 0) { ?>
                                                    <tr>
                                ...
                                <div class="person_ditails" style="margin-top: 50px;">
                                    ...
                                    <?php if(isset($alternative_address)) { ?><span style="font-size:16px;color:#FF6418">Alternative Address: </span><span style="font-size:16px;color:white"><?php echo $alternative_address, ", ", $alternative_town, " ", $alternative_postcode ?><br></span><?php } ?>
                                    <?php if($work_date != 0) { ?><span style="font-size:16px;color:#FF6418">Start Date: </span><span style="font-size:16px;color:white"><?php echo date('D, j F Y', $work_date); ?><br></span><?php } ?>
                                </div>
