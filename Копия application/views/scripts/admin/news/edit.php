...
<input class="submit button button-turquoise" type="button" class="button button-turquoise" value="Редактировать новость" onclick="validate()"/>
<br/>
<br/>
<div class="widget">
    <form method="post" action="<?php echo URL::base(); ?>admin/news/edit/<?php echo $id; ?>" class="form-horizontal" id="edit-form-submit"
