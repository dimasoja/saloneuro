            ...
            <form class="form-horizontal" id='asdf' style="text-align:center;">
                ...
                <div class="widget-content no-padding">
                    <div class="form-row">
                        ...
                        <div class="field">
                            <textarea name="content" id="benefits"
    ...
    <script type="">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery('.tutu').click(function () {
                CKEDITOR.instances['benefits'].updateElement();
                var benefits = jQuery('#benefits').val();
                jQuery.post('/admin/index/savebenefits', {benefits: benefits}, function (data) {
                    console.log(data);
