...
<div class="inner-content">
    <div class="widget-content" align="center">
        <a href="#" class="button button-blue marginbottom30"><img src="/images/admin/icon/14x14/white/download4.png" alt=""> Добавить страницу</a>
        <br/>
        <br/>
        <div class="category-toggle" style="display: none;overflow:auto">
            <div class="span4" style="float: none !important; width:100%; margin-left:0px ">
                <div class="widget">
                    <form class="form-horizontal" action="/admin/information/newpage" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="widget-content no-padding">
                            ...
                            <div class="form-row">
                                ...
                                <div class="field" style="text-align: left;">
                                    <input type="checkbox" name="featured" class="uniform">
                                </div>
                            </div>
                            <div class="form-row">
    ...
    <script type="text/javascript">
        function deletecat(id) {
            if (confirm('Вы уверены?')) {
                window.location = '/admin/information/delete/' + id;
            }
        }

        function edit(id) {
            window.location = '/admin/information/editpage/' + id;
        }
