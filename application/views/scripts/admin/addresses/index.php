            ...
            <form class="form-horizontal" style="text-align:center;">
                ...
                <div class="widget-content no-padding">
                    <div class="form-row">
                        ...
                        <div class="field">
                            <input type="text" class="span12 addr_num" name="standard" id="standard"
                                   value="<?php echo $addr_num; ?>">
                        </div>
                    </div>
                    <br>
    ...
    <div class="span6" style="width:100%">
        <div class="widget">
            <div class="table-container">
                ...
                <table cellpading="0" cellspacing="0" border="0" class="default-table stripped turquoise dataTable"
                       id="dynamic2">
                    <thead>
                    <tr align="left">
                        <th>Номер</th>
                    ...
                    <?php foreach ($addresses as $item) { ?>
                        <tr>
                            ...
                            <td>
                                <?php if($item->type=='address') $function='edit'; else $function='editcity'; ?>
                                <input class="button-turquoise button" value="Редактировать"
                                       onclick="<?php echo $function; ?>(<?php echo $item->id; ?>)"/></td>
...
<div class="inner-content">
    <div class="widget-content" align="center">
        <span class="custom button button-blue marginbottom30"><img src="/images/admin/icon/14x14/white/download4.png"
                                                                    alt=""> Добавить адрес</span>
        <span class="city button button-blue marginbottom30"><img src="/images/admin/icon/14x14/white/download4.png"
                                                                  alt=""> Добавить адреса для города</span>
        <br/>
        <br/>
    ...
    <div class="category-toggle-city" style="display: none;overflow:auto">
        <div class="span4" style="float: none !important; width:100%; margin-left:0px ">
            <div class="widget">
                <form class="form-horizontal" action="/admin/addresses/newcity" method="POST">
                    <div class="widget-header">
                        <h5>Новый:</h5>
                    </div>
                    <div class="widget-content no-padding">
...
<script type="text/javascript">
    ...
    function editcity(id) {
        window.location = '/admin/addresses/editcity/' + id;
    }
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('.custom.button.button-blue.marginbottom30').click(function () {
        ...
        jQuery('.city.button.button-blue.marginbottom30').click(function () {
            if (jQuery('.category-toggle-city').css('display') == 'none') {
                jQuery('.category-toggle-city').slideDown('slow', function () {
                    jQuery(this).css('display', 'block');
                });
            } else {
                jQuery('.category-toggle-city').slideUp('slow', function () {
                    jQuery(this).css('display', 'none');
                });
            }
        });
