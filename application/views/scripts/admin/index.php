...
<div class="row-fluid">
    <div class="widget">
        <form class="form-horizontal" style="text-align:center;">
            ...
            <div class="widget-content no-padding">
                <?php foreach ($settings as $setting) {
                    if (($setting->short_name != 'complex_content') and ($setting->short_name != 'css') and ($setting->short_name != '') and ($setting->short_name != 'cert_title')  and ($setting->short_name != 'cert_description') and ($setting->short_name != 'cert_keywords') and ($setting->short_name != 'call_us') and ($setting->short_name != 'map_code') and ($setting->short_name != 'company_phone') and ($setting->short_name != 'yandex_metrika') and ($setting->short_name != 'goole_analytics') and ($setting->short_name != 'logotext') and ($setting->short_name != 'keywerds') and ($setting->short_name != 'title') and ($setting->short_name != 'description') and ($setting->short_name != 'benefits') and ($setting->short_name != 'production') and ($setting->short_name != 'addr_num') and ($setting->short_name != 'grade') and ($setting->short_name != 'callus') and ($setting->short_name != 'makeorder_content')) {
                        ?>
                        <div class="form-row">
                            <label class="field-name" for="standard"><?php echo $setting->name_setting; ?></label>
