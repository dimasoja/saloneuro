...
<div class="inner-content">
    <div class="widget-content" align="center">
        <a href="#" class="button button-blue marginbottom30"><img src="/images/admin/icon/14x14/white/download4.png" alt=""> Добавить вопрос-ответ</a>
        <br/>
        <br/>
        <div class="category-toggle" style="display: none;overflow:auto">
            <div class="span4" style="float: none !important; width:100%; margin-left:0px ">
                <div class="widget">
                    <form class="form-horizontal" action="/admin/faq/new" method="POST">
                        ...
                        <div class="widget-content no-padding">
                            <div class="form-row">
                                ...
                                <div class="field">
                                    <input type="text" class="input-large name-edit" name="question" style="float: left;width: 100%;">
                                </div>
                            </div>
                            <div class="form-row">
                                <label class="field-name" for="standard">Ответ:</label>
                                <div class="field">
                                    <textarea name="answer" id="add-answer" class="input-large name-edit"></textarea>
                                </div>
                                <br/>
    ...
    <script type="text/javascript">
        ...
        function edit(id) {
            window.location = '/admin/faq/edit/' + id;
        }
