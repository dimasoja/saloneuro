    ...
    <form action="/callback/new" id="callback-form" method="POST">
        <div class="resp">
            ...
            <div class="order-submit">
                <input type="submit" class="order-button green ways-call-submit" value="Заказать звонок"
...
<div class="fancy-link" style="display:none">
    <form action="/consult/new" id="response-form" method="POST">
        ...
        <div class="order-submit">
            <input type="submit" class="order-button green ways-call-submit" value="Отправить" style="margin-left:0px;">
        </div>
